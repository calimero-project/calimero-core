...
public interface Element
{
	 ...
	 * @return <code>true</code> if an attribute with the given name is associated with this
	 ...
	 * <p>
	 * Character data is the element's content without markup. No formatting is done on character
	 * data.<br>
	 * Put it more simple, character data is the actual value information (in textual format) of an
	 * element.
	 *
	 ...
	 * <code>{@literal <Name (S Attribute)* S?/>}</code>, with S being space. Note that if this
	 * method returns <code>false</code>, it does not imply this element has any content, returned
	 * by {@link #getCharacterData()}.
	 *
	 * @return <code>true</code> if empty element with empty element tag, <code>false</code>
	 *         otherwise
	 */
