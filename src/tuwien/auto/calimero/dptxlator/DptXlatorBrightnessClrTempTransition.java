...
public class DptXlatorBrightnessClrTempTransition extends DPTXlator {
	...
	static {
		types = new HashMap<>();
		types.put(DptBrightnessClrTempTransition.getID(), DptBrightnessClrTempTransition);
	}
	 ...
	 */
	public DptXlatorBrightnessClrTempTransition(final DPT dpt) throws KNXFormatException {
		this(dpt.getID());
	}
	 ...
	 */
	public DptXlatorBrightnessClrTempTransition(final String dptId) throws KNXFormatException {
		super(6);
	...
	private String fromDpt(final int index) {
		...
		sb.append((valid & 1) == 1 ? new DecimalFormat("##.#").format(brightness) : "-").append(appendUnit ? " % " : " ");
		sb.append((valid & 2) == 2 ? temperature : "-").append(appendUnit ? " K " : " ");
		sb.append((valid & 4) == 4 ? new DecimalFormat("##.#").format(time) : "-").append(appendUnit ? " s" : "");
		return sb.toString();
	}
