...
public class DatapointMap implements DatapointModel, ChangeNotifier {
    ...
    /**
     * Creates a new empty datapoint map. <p>
     */
    public DatapointMap() {
    ...
    /**
     * Creates a new datapoint map and adds all
     * <code>datapoints</code> to the map. <p> A datapoint to be added has to be
     * unique according its main address, the attempt to add two datapoints
     * using the same main address results in a KNXIllegalArgumentException.
     *
    ...
    /*
     * (non-Javadoc) @see tuwien.auto.calimero.datapoint.DatapointModel#add
    ...
    /*
     * (non-Javadoc) @see tuwien.auto.calimero.datapoint.DatapointModel#remove
     * (tuwien.auto.calimero.datapoint.Datapoint)
     */
    ...
    /*
     * (non-Javadoc) @see
     * tuwien.auto.calimero.datapoint.DatapointModel#removeAll()
     */
    ...
    /*
     * (non-Javadoc) @see tuwien.auto.calimero.datapoint.DatapointModel#get
    ...
    /**
     * Returns all datapoints currently contained in this map. <p>
     *
    ...
    /*
     * (non-Javadoc) @see tuwien.auto.calimero.datapoint.DatapointModel#contains
     * (tuwien.auto.calimero.GroupAddress)
     */
    ...
    /*
     * (non-Javadoc) @see tuwien.auto.calimero.datapoint.DatapointModel#load
    ...
    public void load(final XMLReader r) throws KNXMLException {
        ...
        synchronized (points) {
            while (r.read() == XMLReader.START_TAG) {
                Datapoint dp = null;
                // sets the correct datapoint subclass StateDP or CommandDP
                if (readDPType(r)) {
                    dp = new StateDP(r);
                } else {
                    dp = new CommandDP(r);
    ...
    /*
     * (non-Javadoc) @see tuwien.auto.calimero.datapoint.DatapointModel#save
    ...
    /*
     * (non-Javadoc) @see tuwien.auto.calimero.datapoint.ChangeNotifier#
