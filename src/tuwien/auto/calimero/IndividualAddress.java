 ...
 * <p>
 * An individual address is built up from the 3 levels <i>area</i>, <i>line</i>, and <i>device</i>.
 * The address structure consists of a 16 bit address, consisting of (starting from the most
 * significant bit): area (4 bits), line (4 bits), and device (8 bits). The individual address KNX
 * notation follows <i>area.line.device</i>, with the recommended separator of type '.', or
 * alternatively, '/' (area/line/device).<br>
 * <br>
 * The combined address levels <i>area</i> and <i>line</i> are referred to as subnetwork address,
 * i.e., and described by the higher 8 bits of the address value.<br>
...
public class IndividualAddress extends KNXAddress
{
	 ...
	 * @throws KNXFormatException on unknown address type, wrong address syntax, address values out
	 *         of range, or wrong separator used
	 */
	 ...
	 * @throws KNXMLException if the XML element is no KNXAddress or the address couldn't be read in
	 *         correctly
	 */
