...
public class DPTXlator64BitSigned extends DPTXlator
{
	...
	/* (non-Javadoc)
	 * @see io.calimero.dptxlator.DPTXlator#getValue()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see io.calimero.dptxlator.DPTXlator#getSubTypes()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see io.calimero.dptxlator.DPTXlator#toDPT(java.lang.String, short[], int)
	 */
	@Override
