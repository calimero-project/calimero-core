 ...
 *
 * @see io.calimero.knxnetip.servicetype.ServiceAck
 */
public class ServiceRequest<T extends ServiceType> extends io.calimero.knxnetip.servicetype.ServiceType
{
	...
	public ServiceRequest(final int serviceType, final int channelID, final int seqNumber, final T service)
	{
		...
		svc = service instanceof final CEMI cemi ? (T) CEMIFactory.copy(cemi) : service;
		svcSupplier = null;
	}
