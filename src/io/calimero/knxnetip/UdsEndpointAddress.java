...
public record UdsEndpointAddress(UnixDomainSocketAddress address, long id) implements EndpointAddress {
	public UdsEndpointAddress { Objects.requireNonNull(address); }
